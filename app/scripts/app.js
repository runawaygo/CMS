...
"use strict";
angular.module("MobileCMSApp", ["ngRoute", "restangular", "ui.router", "mgcrea.ngStrap", "common.server.current"]).config([
  "$stateProvider", "$urlRouterProvider", function($stateProvider, $urlRouterProvider) {
    $urlRouterProvider.when("", "/").when("/", "/dashboard").when("/activity", "/activity/list").when("/bulletin", "/bulletin/list").when("/channel", "/channel/list");
